...
int eval() {
    ...
    while(1)
    {
        ...
        {
            ax = *(char *)ax;       /* load char to ax, address in ax*/
        }
        else if(op == LI)
        {
        ...
        {
            *(char *)*sp++ = ax;    /* store char to address in sp, value in ax, address on stack */
        }
        else if(op == SI)
        {
            *(int *)*sp++ = ax;     /*  store int to address in sp, value in ax, address on stack*/
        }
        else if(op == PUSH)
        {
            --sp;
        ...
        {
            pc = (int *)*pc;        /* jump to address in pc */
        }
        else if(op == JZ)
        {
            pc = ax ? pc + 1 : (int *)*pc;   /* jump to address in pc if ax is zero */
        }
        else if(op == JNZ)
        {
            pc = ax ? (int *)*pc : pc + 1;   /* jump to address in pc if ax is not zero */
        }
        else if(op == CALL)
        {
